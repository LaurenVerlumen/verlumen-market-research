...
class AmazonCompetitor(Base):
    ...
    fba_fees: Mapped[float | None] = mapped_column(Float, nullable=True)
    review_velocity: Mapped[float | None] = mapped_column(Float, nullable=True)
    fulfillment: Mapped[str | None] = mapped_column(Text, nullable=True)
    active_sellers: Mapped[int | None] = mapped_column(Integer, nullable=True)
    listing_created_at: Mapped[str | None] = mapped_column(Text, nullable=True)
    seller_age_months: Mapped[int | None] = mapped_column(Integer, nullable=True)
    buy_box_owner: Mapped[str | None] = mapped_column(Text, nullable=True)
    size_tier: Mapped[str | None] = mapped_column(Text, nullable=True)
